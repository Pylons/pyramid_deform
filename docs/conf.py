# -*- coding: utf-8 -*-
#
# pyramid_deform documentation build configuration file
#
...
html_theme_options = dict(
    github_url='https://github.com/Pylons/pyramid_deform',
    )
...
latex_documents = [
  ('index', 'pyramid_deform.tex', 'pyramid_deform Documentation',
